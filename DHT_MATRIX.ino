...
#include <DHT.h>
//------------------------------------------------------------
MD_Parola disp = MD_Parola(MD_MAX72XX::FC16_HW, 10, 4);//CLK 13,CS 10,DIN 11
DHT dht(7, DHT11);
//------------------------------------------------------------
...
void setup()
{
  ...
  disp.displayText("S.V.S.V.M School", PA_LEFT, 40, 40, PA_SCROLL_LEFT,PA_SCROLL_LEFT);
}
//==================================================================================
void loop()
{  
...
void dispTemp()
{
    ...
    disp.displayText(message, PA_LEFT, 100, 2000, PA_SCROLL_LEFT,PA_SCROLL_LEFT);
    while(!disp.displayAnimate());  
}
//==================================================================================
void dispHum()
